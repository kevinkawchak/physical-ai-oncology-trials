...
The DSUR generation process aggregates data from multiple sources: the cumulative adverse
event database (maintained by the safety agent), the enrollment and exposure summary (from
the clinops agent), the protocol deviation summary (from the quality agent), and the
investigational product quality summary (from the supply agent). The agent generates each
required DSUR section: Executive Summary, Introduction, Worldwide Marketing Approval
Status, Actions Taken for Safety Reasons, Changes to Reference Safety Information,
Patient Exposure, Individual Case Summaries, Cumulative Tabulated Summary of Serious
Adverse Events, Significant Findings from Clinical Trials, Safety Findings from Non-
interventional Studies, Other Safety Information, Late-Breaking Information, Overview of
Signals, Signal and Risk Evaluation, Benefit-Risk Evaluation, and Summary of Important
Risks. The completed DSUR is routed through the medical monitor for review and approval
before submission to regulatory authorities within 60 days of the Development International
Birth Date (DIBD).
