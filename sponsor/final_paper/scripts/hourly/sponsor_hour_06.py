"""Sponsor activity script for Hour 06 (Morning ramp-up with increasing procedure volume)."""
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_06_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_06_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_06_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 06.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 6.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-06 monitoring cycle for 8 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T06:10:00Z",
        ...
        {
            "timestamp": "2026-03-23T06:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-06 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 06",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T06:40:00Z",
        ...
        {
            "timestamp": "2026-03-23T06:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-06 treatment cycle",
        },
        {
