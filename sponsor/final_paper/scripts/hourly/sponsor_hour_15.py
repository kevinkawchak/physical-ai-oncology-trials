"""Sponsor activity script for Hour 15 (Afternoon declining volume with scheduled wind-down)."""
...
HOUR = 15
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-15"
PATIENT_COUNT = 8
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_15_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_15_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_15_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 15.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 15.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-15 monitoring cycle for 8 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-15 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 15",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T15:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-15 treatment cycle",
        },
        {
            "timestamp": "2026-03-23T15:55:00Z",
