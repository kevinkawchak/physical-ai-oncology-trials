"""Sponsor activity script for Hour 12 (Afternoon steady-state operations)."""
...
HOUR = 12
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-12"
PATIENT_COUNT = 12
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_12_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_12_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_12_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 12.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 12.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-12 monitoring cycle for 12 patients",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Validate enrollment criteria for cohort at 12:05",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Vitals and robot telemetry monitoring at 12:10",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T12:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-12 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 12",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G4",
            "rationale": "Anomaly in robot telemetry at 12:35",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Procedure milestone check at 12:45",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-12 treatment cycle",
        },
        {
