"""Sponsor activity script for Hour 16 (Afternoon declining volume with scheduled wind-down)."""
...
HOUR = 16
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-16"
PATIENT_COUNT = 7
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_16_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_16_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_16_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 16.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 16.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-16 monitoring cycle for 7 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-16 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 16",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-16 treatment cycle",
        },
        {
            "timestamp": "2026-03-23T16:55:00Z",
