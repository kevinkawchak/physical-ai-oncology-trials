"""Sponsor activity script for Hour 10 (Peak morning activity with maximum procedure throughput)."""
...
HOUR = 10
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-10"
PATIENT_COUNT = 14
PERIOD = "peak_morning"
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_10_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_10_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_10_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 10.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 10.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-10 monitoring cycle for 14 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-10 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 10",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-10 treatment cycle",
        },
        {
