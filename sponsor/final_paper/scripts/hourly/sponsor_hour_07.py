"""Sponsor activity script for Hour 07 (Morning ramp-up with increasing procedure volume)."""
...
HOUR = 7
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-07"
PATIENT_COUNT = 10
PERIOD = "morning_ramp"
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_07_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_07_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_07_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 07.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 7.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-07 monitoring cycle for 10 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-07 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 07",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-07 treatment cycle",
        },
        {
