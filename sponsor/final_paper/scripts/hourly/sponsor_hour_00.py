"""Sponsor activity script for Hour 00 (Overnight low-volume operations with minimal staffing)."""
...
HOUR = 0
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-00"
PATIENT_COUNT = 2
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_00_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_00_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_00_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 00.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 0.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-00 monitoring cycle for 2 patients",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Validate enrollment criteria for cohort at 00:05",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Vitals and robot telemetry monitoring at 00:10",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-00 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 00",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G4",
            "rationale": "Anomaly in robot telemetry at 00:35",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Procedure milestone check at 00:45",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-00 treatment cycle",
        },
        {
