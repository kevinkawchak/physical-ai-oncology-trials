"""Sponsor activity script for Hour 05 (Early morning pre-dawn operations with gradual ramp-up)."""
...
HOUR = 5
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-05"
PATIENT_COUNT = 5
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_05_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_05_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_05_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 05.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 5.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-05 monitoring cycle for 5 patients",
        },
        {
            "timestamp": "2026-03-23T05:05:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-05 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 05",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T05:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-05 treatment cycle",
        },
        {
