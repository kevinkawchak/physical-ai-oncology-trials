"""Sponsor activity script for Hour 19 (Evening wind-down with reduced procedure scheduling)."""
...
HOUR = 19
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-19"
PATIENT_COUNT = 5
PERIOD = "evening_wind"
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_19_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_19_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_19_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 19.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 19.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-19 monitoring cycle for 5 patients",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Validate enrollment criteria for cohort at 19:05",
        },
        {
            "timestamp": "2026-03-23T19:10:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Vitals and robot telemetry monitoring at 19:10",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T19:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-19 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 19",
        },
        {
            "timestamp": "2026-03-23T19:35:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G4",
            "rationale": "Anomaly in robot telemetry at 19:35",
        },
        {
            "timestamp": "2026-03-23T19:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Procedure milestone check at 19:45",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-19 treatment cycle",
        },
        {
            "timestamp": "2026-03-23T19:55:00Z",
