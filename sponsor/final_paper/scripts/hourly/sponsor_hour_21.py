"""Sponsor activity script for Hour 21 (Overnight transition to minimal operations)."""
...
HOUR = 21
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-21"
PATIENT_COUNT = 3
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_21_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_21_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_21_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 21.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 21.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-21 monitoring cycle for 3 patients",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Validate enrollment criteria for cohort at 21:05",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Vitals and robot telemetry monitoring at 21:10",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T21:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-21 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 21",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G4",
            "rationale": "Anomaly in robot telemetry at 21:35",
        },
        {
            "timestamp": "2026-03-23T21:40:00Z",
        ...
        {
            "timestamp": "2026-03-23T21:45:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Procedure milestone check at 21:45",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-21 treatment cycle",
        },
        {
            "timestamp": "2026-03-23T21:55:00Z",
