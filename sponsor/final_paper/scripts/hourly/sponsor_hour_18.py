"""Sponsor activity script for Hour 18 (Evening wind-down with reduced procedure scheduling)."""
...
HOUR = 18
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-18"
PATIENT_COUNT = 5
PERIOD = "evening_wind"
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_18_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_18_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_18_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 18.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 18.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-18 monitoring cycle for 5 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T18:10:00Z",
        ...
        {
            "timestamp": "2026-03-23T18:20:00Z",
        ...
        {
            "timestamp": "2026-03-23T18:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-18 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 18",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-18 treatment cycle",
        },
        {
            "timestamp": "2026-03-23T18:55:00Z",
