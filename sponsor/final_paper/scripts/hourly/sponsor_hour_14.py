"""Sponsor activity script for Hour 14 (Afternoon steady-state operations)."""
...
HOUR = 14
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-14"
PATIENT_COUNT = 8
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_14_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_14_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_14_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 14.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 14.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-14 monitoring cycle for 8 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-14 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 14",
        },
        {
        ...
        {
            "timestamp": "2026-03-23T14:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-14 treatment cycle",
        },
        {
