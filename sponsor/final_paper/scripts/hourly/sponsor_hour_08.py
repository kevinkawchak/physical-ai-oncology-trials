"""Sponsor activity script for Hour 08 (Morning ramp-up with increasing procedure volume)."""
...
HOUR = 8
NEW_TRIAL_DIR = Path(__file__).resolve().parents[4] / "new-trial" / "hour-08"
PATIENT_COUNT = 12
PERIOD = "morning_ramp"
...
def _load_trial_data() -> dict:
    ...
    patient_file = NEW_TRIAL_DIR / "hour_08_patient_records.md"
    robot_file = NEW_TRIAL_DIR / "hour_08_robot_logs.md"
    sim_file = NEW_TRIAL_DIR / "hour_08_simulation.md"
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 08.

    Parameters
    ----------
    hour : int
        The hour (0-23) to generate directives for. Defaults to 8.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-08 monitoring cycle for 12 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-08 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 08",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-08 treatment cycle",
        },
        {
    ...
    return {
        "hour": hour,
        "period": PERIOD,
        "description": "Morning ramp-up with increasing procedure volume",
