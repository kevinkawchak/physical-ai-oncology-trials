"""Sponsor activity script for Hour 089 (Day 4, 17:00 - Evening transition to reduced operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 089.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 89.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-089 monitoring cycle for 9 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T17:20:00Z",
        ...
        {
            "timestamp": "2026-03-26T17:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-089 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 089",
        },
        {
            "timestamp": "2026-03-26T17:35:00Z",
        ...
        {
            "timestamp": "2026-03-26T17:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-089 treatment cycle",
        },
        {
