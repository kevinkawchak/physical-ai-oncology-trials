"""Sponsor activity script for Hour 091 (Day 4, 19:00 - Evening wind-down period)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 091.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 91.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-091 monitoring cycle for 6 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T19:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-091 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 091",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T19:40:00Z",
        ...
        {
            "timestamp": "2026-03-26T19:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-091 treatment cycle",
        },
        {
