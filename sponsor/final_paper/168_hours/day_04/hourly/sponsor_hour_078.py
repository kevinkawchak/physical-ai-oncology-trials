"""Sponsor activity script for Hour 078 (Day 4, 06:00 - Morning ramp-up with increasing patient arrivals)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 078.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 78.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-078 monitoring cycle for 11 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T06:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-078 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 078",
        },
        {
            "timestamp": "2026-03-26T06:35:00Z",
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-078 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T06:55:00Z",
