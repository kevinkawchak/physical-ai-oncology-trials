"""Sponsor activity script for Hour 079 (Day 4, 07:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 079.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 79.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-079 monitoring cycle for 14 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T07:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-079 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 079",
        },
        {
            "timestamp": "2026-03-26T07:35:00Z",
        ...
        {
            "timestamp": "2026-03-26T07:40:00Z",
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-079 treatment cycle",
        },
        {
