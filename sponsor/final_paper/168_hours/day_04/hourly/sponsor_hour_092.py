"""Sponsor activity script for Hour 092 (Day 4, 20:00 - Night transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 092.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 92.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-092 monitoring cycle for 5 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-092 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 092",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T20:40:00Z",
        ...
        {
            "timestamp": "2026-03-26T20:45:00Z",
        ...
        {
            "timestamp": "2026-03-26T20:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-092 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T20:55:00Z",
