"""Sponsor activity script for Hour 084 (Day 4, 12:00 - Midday steady-state operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 084.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 84.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-084 monitoring cycle for 12 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T12:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-084 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 084",
        },
        {
            "timestamp": "2026-03-26T12:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-084 treatment cycle",
        },
        {
    ...
    return {
        ...
        "period": PERIOD,
        "description": "Midday steady-state operations",
