"""Sponsor activity script for Hour 082 (Day 4, 10:00 - Peak operational period with maximum throughput)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 082.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 82.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-082 monitoring cycle for 17 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-082 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 082",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": True,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-082 treatment cycle",
        },
        {
