"""Sponsor activity script for Hour 083 (Day 4, 11:00 - Peak operational period with maximum throughput)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 083.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 83.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-083 monitoring cycle for 14 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-083 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 083",
        },
        {
            "timestamp": "2026-03-26T11:35:00Z",
        ...
        {
            "timestamp": "2026-03-26T11:40:00Z",
        ...
        {
            "timestamp": "2026-03-26T11:50:00Z",
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-083 treatment cycle",
        },
        {
