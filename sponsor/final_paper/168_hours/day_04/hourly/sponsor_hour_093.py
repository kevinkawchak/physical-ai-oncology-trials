"""Sponsor activity script for Hour 093 (Day 4, 21:00 - Night operations with skeleton crew)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 093.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 93.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-093 monitoring cycle for 4 patients",
        },
        {
            "timestamp": "2026-03-26T21:05:00Z",
        ...
        {
            "timestamp": "2026-03-26T21:10:00Z",
        ...
        {
            "timestamp": "2026-03-26T21:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-26T21:20:00Z",
        ...
        {
            "timestamp": "2026-03-26T21:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-093 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 093",
        },
        {
            "timestamp": "2026-03-26T21:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-093 treatment cycle",
        },
        {
    ...
    return {
        ...
        "period": PERIOD,
        "description": "Night operations with skeleton crew",
