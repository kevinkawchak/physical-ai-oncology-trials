"""Sponsor activity script for Hour 088 (Day 4, 16:00 - Late afternoon wind-down beginning)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 088.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 88.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-088 monitoring cycle for 10 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T16:10:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-088 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 088",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-088 treatment cycle",
        },
        {
