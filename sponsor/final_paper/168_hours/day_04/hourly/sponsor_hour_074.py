"""Sponsor activity script for Hour 074 (Day 4, 02:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 074.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 74.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-074 monitoring cycle for 5 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-074 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 074",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T02:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-074 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T02:55:00Z",
