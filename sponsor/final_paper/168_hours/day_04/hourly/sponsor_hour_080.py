"""Sponsor activity script for Hour 080 (Day 4, 08:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 080.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 80.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-080 monitoring cycle for 17 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-080 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 080",
        },
        {
            "timestamp": "2026-03-26T08:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G1",
            "rationale": "Status aggregation for 17 active pathways",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": True,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-080 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T08:55:00Z",
