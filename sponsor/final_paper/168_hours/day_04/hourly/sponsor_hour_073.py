"""Sponsor activity script for Hour 073 (Day 4, 01:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 073.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 73.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-073 monitoring cycle for 5 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T01:20:00Z",
        ...
        {
            "timestamp": "2026-03-26T01:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-073 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 073",
        },
        {
        ...
        {
            "timestamp": "2026-03-26T01:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-073 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T01:55:00Z",
