"""Sponsor activity script for Hour 085 (Day 4, 13:00 - Afternoon clinical operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 085.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 85.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-085 monitoring cycle for 13 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-085 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 085",
        },
        {
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-085 treatment cycle",
        },
        {
            "timestamp": "2026-03-26T13:55:00Z",
