"""Sponsor activity script for Hour 118 (Day 5, 22:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 118.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 118.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-118 monitoring cycle for 3 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T22:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-118 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 118",
        },
        {
            "timestamp": "2026-03-27T22:35:00Z",
        ...
        {
            "timestamp": "2026-03-27T22:40:00Z",
        ...
        {
            "timestamp": "2026-03-27T22:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-118 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T22:55:00Z",
