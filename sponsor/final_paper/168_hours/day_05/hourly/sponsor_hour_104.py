"""Sponsor activity script for Hour 104 (Day 5, 08:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 104.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 104.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-104 monitoring cycle for 15 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T08:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-104 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 104",
        },
        {
            "timestamp": "2026-03-27T08:35:00Z",
        ...
        {
            "timestamp": "2026-03-27T08:50:00Z",
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-104 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T08:55:00Z",
