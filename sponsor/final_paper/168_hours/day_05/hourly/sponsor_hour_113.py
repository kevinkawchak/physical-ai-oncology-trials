"""Sponsor activity script for Hour 113 (Day 5, 17:00 - Evening transition to reduced operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 113.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 113.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-113 monitoring cycle for 7 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-113 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 113",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T17:40:00Z",
        ...
        {
            "timestamp": "2026-03-27T17:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-113 treatment cycle",
        },
        {
