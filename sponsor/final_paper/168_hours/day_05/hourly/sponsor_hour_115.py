"""Sponsor activity script for Hour 115 (Day 5, 19:00 - Evening wind-down period)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 115.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 115.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-115 monitoring cycle for 5 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-115 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 115",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T19:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-115 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T19:55:00Z",
