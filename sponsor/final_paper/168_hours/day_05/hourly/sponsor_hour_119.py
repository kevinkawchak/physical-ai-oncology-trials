"""Sponsor activity script for Hour 119 (Day 5, 23:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 119.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 119.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-119 monitoring cycle for 2 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T23:10:00Z",
        ...
        {
            "timestamp": "2026-03-27T23:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-27T23:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-119 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 119",
        },
        {
            "timestamp": "2026-03-27T23:35:00Z",
        ...
        {
            "timestamp": "2026-03-27T23:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-119 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T23:55:00Z",
