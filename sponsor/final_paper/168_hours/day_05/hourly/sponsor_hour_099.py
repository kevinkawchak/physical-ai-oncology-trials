"""Sponsor activity script for Hour 099 (Day 5, 03:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 099.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 99.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-099 monitoring cycle for 5 patients",
        },
        {
            "timestamp": "2026-03-27T03:05:00Z",
        ...
        {
            "timestamp": "2026-03-27T03:15:00Z",
            "decision_type": "AUTH",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-099 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 099",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T03:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-099 treatment cycle",
        },
        {
