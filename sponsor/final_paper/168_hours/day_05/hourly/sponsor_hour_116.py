"""Sponsor activity script for Hour 116 (Day 5, 20:00 - Night transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 116.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 116.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-116 monitoring cycle for 4 patients",
        },
        {
            "timestamp": "2026-03-27T20:05:00Z",
        ...
        {
            "timestamp": "2026-03-27T20:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-116 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 116",
        },
        {
            "timestamp": "2026-03-27T20:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-116 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T20:55:00Z",
