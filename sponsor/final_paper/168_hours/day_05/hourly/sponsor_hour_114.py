"""Sponsor activity script for Hour 114 (Day 5, 18:00 - Evening operations with reduced staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 114.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 114.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-114 monitoring cycle for 6 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-114 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 114",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T18:40:00Z",
        ...
        {
            "timestamp": "2026-03-27T18:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-114 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T18:55:00Z",
