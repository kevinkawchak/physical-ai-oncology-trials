"""Sponsor activity script for Hour 117 (Day 5, 21:00 - Night operations with skeleton crew)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 117.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 117.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-117 monitoring cycle for 3 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-117 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 117",
        },
        {
            "timestamp": "2026-03-27T21:35:00Z",
        ...
        {
            "timestamp": "2026-03-27T21:40:00Z",
        ...
        {
            "timestamp": "2026-03-27T21:45:00Z",
        ...
        {
            "timestamp": "2026-03-27T21:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-117 treatment cycle",
        },
        {
