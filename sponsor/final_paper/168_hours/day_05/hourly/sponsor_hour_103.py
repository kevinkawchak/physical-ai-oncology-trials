"""Sponsor activity script for Hour 103 (Day 5, 07:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 103.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 103.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-103 monitoring cycle for 13 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T07:20:00Z",
        ...
        {
            "timestamp": "2026-03-27T07:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-103 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 103",
        },
        {
            "timestamp": "2026-03-27T07:35:00Z",
        ...
        {
            "timestamp": "2026-03-27T07:50:00Z",
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-103 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T07:55:00Z",
