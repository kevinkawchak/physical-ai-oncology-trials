"""Sponsor activity script for Hour 100 (Day 5, 04:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 100.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 100.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-100 monitoring cycle for 6 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T04:10:00Z",
        ...
        {
            "timestamp": "2026-03-27T04:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-100 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 100",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T04:40:00Z",
        ...
        {
            "timestamp": "2026-03-27T04:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-100 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T04:55:00Z",
