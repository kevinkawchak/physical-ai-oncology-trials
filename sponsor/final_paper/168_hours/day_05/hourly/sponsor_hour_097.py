"""Sponsor activity script for Hour 097 (Day 5, 01:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 097.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 97.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-097 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T01:15:00Z",
            "decision_type": "AUTH",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-097 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 097",
        },
        {
        ...
        {
            "timestamp": "2026-03-27T01:45:00Z",
        ...
        {
            "timestamp": "2026-03-27T01:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-097 treatment cycle",
        },
        {
