"""Sponsor activity script for Hour 112 (Day 5, 16:00 - Late afternoon wind-down beginning)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 112.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 112.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-112 monitoring cycle for 9 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-112 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 112",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-112 treatment cycle",
        },
        {
            "timestamp": "2026-03-27T16:55:00Z",
