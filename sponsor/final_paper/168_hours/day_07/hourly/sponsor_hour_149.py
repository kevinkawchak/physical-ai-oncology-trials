"""Sponsor activity script for Hour 149 (Day 7, 05:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 149.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 149.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-149 monitoring cycle for 6 patients",
        },
        {
            "timestamp": "2026-03-29T05:05:00Z",
        ...
        {
            "timestamp": "2026-03-29T05:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-29T05:20:00Z",
        ...
        {
            "timestamp": "2026-03-29T05:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-149 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 149",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-149 treatment cycle",
        },
        {
