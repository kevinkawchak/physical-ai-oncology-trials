"""Sponsor activity script for Hour 151 (Day 7, 07:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 151.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 151.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-151 monitoring cycle for 10 patients",
        },
        {
            "timestamp": "2026-03-29T07:05:00Z",
        ...
        {
            "timestamp": "2026-03-29T07:10:00Z",
        ...
        {
            "timestamp": "2026-03-29T07:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-29T07:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-151 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 151",
        },
        {
            "timestamp": "2026-03-29T07:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T07:40:00Z",
        ...
        {
            "timestamp": "2026-03-29T07:45:00Z",
        ...
        {
            "timestamp": "2026-03-29T07:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-151 treatment cycle",
        },
        {
