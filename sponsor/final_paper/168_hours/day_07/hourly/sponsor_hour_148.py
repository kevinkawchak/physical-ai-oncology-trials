"""Sponsor activity script for Hour 148 (Day 7, 04:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 148.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 148.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-148 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T04:10:00Z",
        ...
        {
            "timestamp": "2026-03-29T04:20:00Z",
        ...
        {
            "timestamp": "2026-03-29T04:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-148 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 148",
        },
        {
            "timestamp": "2026-03-29T04:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-148 treatment cycle",
        },
        {
