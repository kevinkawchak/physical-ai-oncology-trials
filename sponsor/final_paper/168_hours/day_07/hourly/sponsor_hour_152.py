"""Sponsor activity script for Hour 152 (Day 7, 08:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 152.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 152.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-152 monitoring cycle for 12 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T08:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-152 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 152",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T08:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-152 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T08:55:00Z",
