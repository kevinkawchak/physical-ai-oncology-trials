"""Sponsor activity script for Hour 162 (Day 7, 18:00 - Evening operations with reduced staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 162.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 162.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-162 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T18:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-162 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 162",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-162 treatment cycle",
        },
        {
