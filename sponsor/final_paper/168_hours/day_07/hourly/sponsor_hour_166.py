"""Sponsor activity script for Hour 166 (Day 7, 22:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 166.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 166.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-166 monitoring cycle for 2 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-166 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 166",
        },
        {
            "timestamp": "2026-03-29T22:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T22:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-166 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T22:55:00Z",
