"""Sponsor activity script for Hour 156 (Day 7, 12:00 - Midday steady-state operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 156.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 156.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-156 monitoring cycle for 8 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-156 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 156",
        },
        {
            "timestamp": "2026-03-29T12:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T12:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-156 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T12:55:00Z",
