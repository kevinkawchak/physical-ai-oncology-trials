"""Sponsor activity script for Hour 150 (Day 7, 06:00 - Morning ramp-up with increasing patient arrivals)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 150.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 150.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-150 monitoring cycle for 8 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-150 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 150",
        },
        {
            "timestamp": "2026-03-29T06:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T06:40:00Z",
        ...
        {
            "timestamp": "2026-03-29T06:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-150 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T06:55:00Z",
