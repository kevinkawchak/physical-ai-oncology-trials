"""Sponsor activity script for Hour 147 (Day 7, 03:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 147.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 147.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-147 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T03:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-147 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 147",
        },
        {
            "timestamp": "2026-03-29T03:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T03:40:00Z",
        ...
        {
            "timestamp": "2026-03-29T03:45:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-147 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T03:55:00Z",
