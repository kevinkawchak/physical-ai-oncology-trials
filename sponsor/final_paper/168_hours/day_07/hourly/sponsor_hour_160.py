"""Sponsor activity script for Hour 160 (Day 7, 16:00 - Late afternoon wind-down beginning)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 160.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 160.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-160 monitoring cycle for 7 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-160 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 160",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T16:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-160 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T16:55:00Z",
