"""Sponsor activity script for Hour 165 (Day 7, 21:00 - Night operations with skeleton crew)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 165.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 165.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-165 monitoring cycle for 2 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T21:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-165 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 165",
        },
        {
            "timestamp": "2026-03-29T21:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T21:40:00Z",
        ...
        {
            "timestamp": "2026-03-29T21:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-165 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T21:55:00Z",
