"""Sponsor activity script for Hour 167 (Day 7, 23:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 167.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 167.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-167 monitoring cycle for 1 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T23:10:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-167 procedures",
        },
        {
            "timestamp": "2026-03-29T23:30:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 167",
        },
        {
            "timestamp": "2026-03-29T23:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T23:40:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G1",
            "rationale": "Status aggregation for 1 active pathways",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-167 treatment cycle",
        },
        {
