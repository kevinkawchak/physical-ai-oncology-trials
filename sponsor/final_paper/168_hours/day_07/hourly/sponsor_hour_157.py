"""Sponsor activity script for Hour 157 (Day 7, 13:00 - Afternoon clinical operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 157.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 157.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-157 monitoring cycle for 9 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-29T13:10:00Z",
        ...
        {
            "timestamp": "2026-03-29T13:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-157 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 157",
        },
        {
            "timestamp": "2026-03-29T13:35:00Z",
        ...
        {
            "timestamp": "2026-03-29T13:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-157 treatment cycle",
        },
        {
            "timestamp": "2026-03-29T13:55:00Z",
