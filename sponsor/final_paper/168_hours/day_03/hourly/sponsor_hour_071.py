"""Sponsor activity script for Hour 071 (Day 3, 23:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 071.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 71.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-071 monitoring cycle for 3 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-071 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 071",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T23:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-071 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T23:55:00Z",
