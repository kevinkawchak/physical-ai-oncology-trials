"""Sponsor activity script for Hour 066 (Day 3, 18:00 - Evening operations with reduced staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 066.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 66.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-066 monitoring cycle for 7 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T18:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-066 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 066",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T18:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-066 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T18:55:00Z",
