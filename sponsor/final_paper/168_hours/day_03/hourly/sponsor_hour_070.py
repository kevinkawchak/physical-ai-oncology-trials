"""Sponsor activity script for Hour 070 (Day 3, 22:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 070.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 70.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-070 monitoring cycle for 3 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T22:20:00Z",
        ...
        {
            "timestamp": "2026-03-25T22:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-070 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 070",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-070 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T22:55:00Z",
