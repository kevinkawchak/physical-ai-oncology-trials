"""Sponsor activity script for Hour 069 (Day 3, 21:00 - Night operations with skeleton crew)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 069.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 69.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-069 monitoring cycle for 4 patients",
        },
        {
            "timestamp": "2026-03-25T21:05:00Z",
        ...
        {
            "timestamp": "2026-03-25T21:20:00Z",
        ...
        {
            "timestamp": "2026-03-25T21:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-069 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 069",
        },
        {
            "timestamp": "2026-03-25T21:35:00Z",
        ...
        {
            "timestamp": "2026-03-25T21:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-069 treatment cycle",
        },
        {
