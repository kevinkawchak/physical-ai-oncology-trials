"""Sponsor activity script for Hour 063 (Day 3, 15:00 - Afternoon steady-state with moderate volume)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 063.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 63.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-063 monitoring cycle for 11 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-063 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 063",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-063 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T15:55:00Z",
