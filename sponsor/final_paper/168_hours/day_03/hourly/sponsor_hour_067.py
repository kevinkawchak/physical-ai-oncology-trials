"""Sponsor activity script for Hour 067 (Day 3, 19:00 - Evening wind-down period)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 067.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 67.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-067 monitoring cycle for 6 patients",
        },
        {
            "timestamp": "2026-03-25T19:05:00Z",
        ...
        {
            "timestamp": "2026-03-25T19:10:00Z",
        ...
        {
            "timestamp": "2026-03-25T19:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-067 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 067",
        },
        {
            "timestamp": "2026-03-25T19:35:00Z",
        ...
        {
            "timestamp": "2026-03-25T19:40:00Z",
        ...
        {
            "timestamp": "2026-03-25T19:45:00Z",
        ...
        {
            "timestamp": "2026-03-25T19:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-067 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T19:55:00Z",
    ...
    return {
        ...
        "period": PERIOD,
        "description": "Evening wind-down period",
