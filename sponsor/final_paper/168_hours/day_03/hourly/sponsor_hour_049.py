"""Sponsor activity script for Hour 049 (Day 3, 01:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 049.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 49.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-049 monitoring cycle for 4 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-049 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 049",
        },
        {
            "timestamp": "2026-03-25T01:35:00Z",
        ...
        {
            "timestamp": "2026-03-25T01:40:00Z",
        ...
        {
            "timestamp": "2026-03-25T01:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-049 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T01:55:00Z",
