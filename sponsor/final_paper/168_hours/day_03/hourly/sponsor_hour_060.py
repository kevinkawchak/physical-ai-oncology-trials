"""Sponsor activity script for Hour 060 (Day 3, 12:00 - Midday steady-state operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 060.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 60.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-060 monitoring cycle for 11 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T12:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-060 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 060",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T12:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-060 treatment cycle",
        },
        {
