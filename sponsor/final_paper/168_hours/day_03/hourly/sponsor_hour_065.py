"""Sponsor activity script for Hour 065 (Day 3, 17:00 - Evening transition to reduced operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 065.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 65.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-065 monitoring cycle for 8 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-065 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 065",
        },
        {
        ...
        {
            "timestamp": "2026-03-25T17:40:00Z",
        ...
        {
            "timestamp": "2026-03-25T17:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-065 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T17:55:00Z",
