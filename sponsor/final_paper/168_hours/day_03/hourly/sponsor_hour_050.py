"""Sponsor activity script for Hour 050 (Day 3, 02:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 050.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 50.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-050 monitoring cycle for 4 patients",
        },
        {
            "timestamp": "2026-03-25T02:05:00Z",
        ...
        {
            "timestamp": "2026-03-25T02:20:00Z",
        ...
        {
            "timestamp": "2026-03-25T02:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-050 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 050",
        },
        {
            "timestamp": "2026-03-25T02:35:00Z",
        ...
        {
            "timestamp": "2026-03-25T02:40:00Z",
        ...
        {
            "timestamp": "2026-03-25T02:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-050 treatment cycle",
        },
        {
            "timestamp": "2026-03-25T02:55:00Z",
