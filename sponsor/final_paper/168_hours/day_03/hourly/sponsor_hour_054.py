"""Sponsor activity script for Hour 054 (Day 3, 06:00 - Morning ramp-up with increasing patient arrivals)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 054.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 54.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-054 monitoring cycle for 12 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-054 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 054",
        },
        {
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-054 treatment cycle",
        },
        {
