"""Sponsor activity script for Hour 041 (Day 2, 17:00 - Evening transition to reduced operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 041.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 41.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-041 monitoring cycle for 8 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T17:10:00Z",
        ...
        {
            "timestamp": "2026-03-24T17:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-041 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 041",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-041 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T17:55:00Z",
