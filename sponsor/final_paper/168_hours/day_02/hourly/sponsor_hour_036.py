"""Sponsor activity script for Hour 036 (Day 2, 12:00 - Midday steady-state operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 036.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 36.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-036 monitoring cycle for 10 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-036 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 036",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T12:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-036 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T12:55:00Z",
