"""Sponsor activity script for Hour 030 (Day 2, 06:00 - Morning ramp-up with increasing patient arrivals)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 030.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 30.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-030 monitoring cycle for 10 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T06:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-030 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 030",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T06:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-030 treatment cycle",
        },
        {
