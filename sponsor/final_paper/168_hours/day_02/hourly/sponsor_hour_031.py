"""Sponsor activity script for Hour 031 (Day 2, 07:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 031.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 31.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-031 monitoring cycle for 13 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T07:10:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-031 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 031",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T07:40:00Z",
        ...
        {
            "timestamp": "2026-03-24T07:45:00Z",
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-031 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T07:55:00Z",
