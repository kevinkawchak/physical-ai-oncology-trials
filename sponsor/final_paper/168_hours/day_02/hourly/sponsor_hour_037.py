"""Sponsor activity script for Hour 037 (Day 2, 13:00 - Afternoon clinical operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 037.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 37.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-037 monitoring cycle for 11 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-037 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 037",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T13:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-037 treatment cycle",
        },
        {
