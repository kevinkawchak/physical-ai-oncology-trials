"""Sponsor activity script for Hour 038 (Day 2, 14:00 - Afternoon clinical operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 038.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 38.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-038 monitoring cycle for 12 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-038 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 038",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-038 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T14:55:00Z",
