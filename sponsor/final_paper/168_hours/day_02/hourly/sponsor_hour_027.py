"""Sponsor activity script for Hour 027 (Day 2, 03:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 027.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 27.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-027 monitoring cycle for 5 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-027 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 027",
        },
        {
            "timestamp": "2026-03-24T03:35:00Z",
        ...
        {
            "timestamp": "2026-03-24T03:45:00Z",
        ...
        {
            "timestamp": "2026-03-24T03:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-027 treatment cycle",
        },
        {
