"""Sponsor activity script for Hour 044 (Day 2, 20:00 - Night transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 044.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 44.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-044 monitoring cycle for 4 patients",
        },
        {
            "timestamp": "2026-03-24T20:05:00Z",
        ...
        {
            "timestamp": "2026-03-24T20:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-044 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 044",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-044 treatment cycle",
        },
        {
