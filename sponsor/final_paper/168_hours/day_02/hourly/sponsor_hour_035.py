"""Sponsor activity script for Hour 035 (Day 2, 11:00 - Peak operational period with maximum throughput)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 035.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 35.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-035 monitoring cycle for 12 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T11:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-035 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 035",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-035 treatment cycle",
        },
        {
