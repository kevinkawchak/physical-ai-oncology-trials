"""Sponsor activity script for Hour 034 (Day 2, 10:00 - Peak operational period with maximum throughput)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 034.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 34.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-034 monitoring cycle for 15 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-034 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 034",
        },
        {
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-034 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T10:55:00Z",
