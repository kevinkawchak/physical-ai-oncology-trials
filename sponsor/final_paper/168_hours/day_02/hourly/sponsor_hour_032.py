"""Sponsor activity script for Hour 032 (Day 2, 08:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 032.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 32.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-032 monitoring cycle for 15 patients",
        },
        {
            "timestamp": "2026-03-24T08:05:00Z",
        ...
        {
            "timestamp": "2026-03-24T08:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-032 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 032",
        },
        {
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-032 treatment cycle",
        },
        {
