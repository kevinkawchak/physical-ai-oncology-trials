"""Sponsor activity script for Hour 028 (Day 2, 04:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 028.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 28.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-028 monitoring cycle for 5 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T04:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-24T04:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-028 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 028",
        },
        {
            "timestamp": "2026-03-24T04:35:00Z",
        ...
        {
            "timestamp": "2026-03-24T04:40:00Z",
        ...
        {
            "timestamp": "2026-03-24T04:45:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-028 treatment cycle",
        },
        {
