"""Sponsor activity script for Hour 042 (Day 2, 18:00 - Evening operations with reduced staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 042.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 42.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-042 monitoring cycle for 6 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-042 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 042",
        },
        {
            "timestamp": "2026-03-24T18:35:00Z",
        ...
        {
            "timestamp": "2026-03-24T18:40:00Z",
        ...
        {
            "timestamp": "2026-03-24T18:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-042 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T18:55:00Z",
