"""Sponsor activity script for Hour 045 (Day 2, 21:00 - Night operations with skeleton crew)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 045.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 45.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-045 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T21:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-045 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 045",
        },
        {
            "timestamp": "2026-03-24T21:35:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-045 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T21:55:00Z",
