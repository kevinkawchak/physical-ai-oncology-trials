"""Sponsor activity script for Hour 025 (Day 2, 01:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 025.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 25.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-025 monitoring cycle for 4 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-025 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 025",
        },
        {
        ...
        {
            "timestamp": "2026-03-24T01:45:00Z",
        ...
        {
            "timestamp": "2026-03-24T01:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-025 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T01:55:00Z",
