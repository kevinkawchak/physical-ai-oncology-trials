"""Sponsor activity script for Hour 029 (Day 2, 05:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 029.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 29.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-029 monitoring cycle for 7 patients",
        },
        {
            "timestamp": "2026-03-24T05:05:00Z",
        ...
        {
            "timestamp": "2026-03-24T05:15:00Z",
            "decision_type": "AUTH",
        ...
        {
            "timestamp": "2026-03-24T05:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-029 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 029",
        },
        {
            "timestamp": "2026-03-24T05:35:00Z",
        ...
        {
            "timestamp": "2026-03-24T05:40:00Z",
        ...
        {
            "timestamp": "2026-03-24T05:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-029 treatment cycle",
        },
        {
            "timestamp": "2026-03-24T05:55:00Z",
