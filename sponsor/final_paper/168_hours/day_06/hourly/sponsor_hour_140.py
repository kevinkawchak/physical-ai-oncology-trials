"""Sponsor activity script for Hour 140 (Day 6, 20:00 - Night transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 140.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 140.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-140 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T20:10:00Z",
        ...
        {
            "timestamp": "2026-03-28T20:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-140 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 140",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T20:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-140 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T20:55:00Z",
