"""Sponsor activity script for Hour 138 (Day 6, 18:00 - Evening operations with reduced staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 138.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 138.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-138 monitoring cycle for 5 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T18:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-138 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 138",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T18:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-138 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T18:55:00Z",
