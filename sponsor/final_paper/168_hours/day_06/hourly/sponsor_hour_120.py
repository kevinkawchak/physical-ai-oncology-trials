"""Sponsor activity script for Hour 120 (Day 6, 00:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 120.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 120.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-120 monitoring cycle for 3 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-120 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 120",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T00:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-120 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T00:55:00Z",
