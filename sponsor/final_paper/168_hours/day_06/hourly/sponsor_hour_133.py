"""Sponsor activity script for Hour 133 (Day 6, 13:00 - Afternoon clinical operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 133.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 133.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-133 monitoring cycle for 10 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T13:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-133 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 133",
        },
        {
            "timestamp": "2026-03-28T13:35:00Z",
        ...
        {
            "timestamp": "2026-03-28T13:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-133 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T13:55:00Z",
