"""Sponsor activity script for Hour 126 (Day 6, 06:00 - Morning ramp-up with increasing patient arrivals)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 126.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 126.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-126 monitoring cycle for 9 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T06:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-126 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 126",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T06:40:00Z",
        ...
        {
            "timestamp": "2026-03-28T06:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-126 treatment cycle",
        },
        {
