"""Sponsor activity script for Hour 122 (Day 6, 02:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 122.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 122.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-122 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T02:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-122 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 122",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T02:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-122 treatment cycle",
        },
        {
