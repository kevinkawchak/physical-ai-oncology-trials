"""Sponsor activity script for Hour 135 (Day 6, 15:00 - Afternoon steady-state with moderate volume)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 135.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 135.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-135 monitoring cycle for 9 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T15:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-135 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 135",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-135 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T15:55:00Z",
