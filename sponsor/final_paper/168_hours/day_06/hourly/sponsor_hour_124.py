"""Sponsor activity script for Hour 124 (Day 6, 04:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 124.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 124.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-124 monitoring cycle for 5 patients",
        },
        {
            "timestamp": "2026-03-28T04:05:00Z",
        ...
        {
            "timestamp": "2026-03-28T04:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-124 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 124",
        },
        {
            "timestamp": "2026-03-28T04:35:00Z",
        ...
        {
            "timestamp": "2026-03-28T04:40:00Z",
        ...
        {
            "timestamp": "2026-03-28T04:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-124 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T04:55:00Z",
