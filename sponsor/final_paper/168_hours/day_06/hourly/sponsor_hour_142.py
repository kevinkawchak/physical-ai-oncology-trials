"""Sponsor activity script for Hour 142 (Day 6, 22:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 142.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 142.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-142 monitoring cycle for 2 patients",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-142 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 142",
        },
        {
            "timestamp": "2026-03-28T22:35:00Z",
        ...
        {
            "timestamp": "2026-03-28T22:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-142 treatment cycle",
        },
        {
