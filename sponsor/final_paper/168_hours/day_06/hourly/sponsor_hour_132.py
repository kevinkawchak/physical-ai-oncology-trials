"""Sponsor activity script for Hour 132 (Day 6, 12:00 - Midday steady-state operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 132.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 132.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-132 monitoring cycle for 9 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T12:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-132 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 132",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G1",
            "rationale": "Status aggregation for 9 active pathways",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T12:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-132 treatment cycle",
        },
        {
