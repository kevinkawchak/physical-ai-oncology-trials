"""Sponsor activity script for Hour 121 (Day 6, 01:00 - Overnight low-volume operations with minimal staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 121.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 121.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-121 monitoring cycle for 4 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T01:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-121 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 121",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-121 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T01:55:00Z",
