"""Sponsor activity script for Hour 128 (Day 6, 08:00 - Morning peak operations with full staffing)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 128.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 128.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-128 monitoring cycle for 14 patients",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T08:25:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-128 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 128",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T08:40:00Z",
        ...
        },
        {
            ...
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-128 treatment cycle",
        },
        {
