"""Sponsor activity script for Hour 143 (Day 6, 23:00 - Overnight transition to minimal operations)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 143.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 143.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-143 monitoring cycle for 2 patients",
        },
        {
            "timestamp": "2026-03-28T23:05:00Z",
        ...
        {
            "timestamp": "2026-03-28T23:10:00Z",
        ...
        {
            "timestamp": "2026-03-28T23:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-143 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 143",
        },
        {
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-143 treatment cycle",
        },
        {
