"""Sponsor activity script for Hour 125 (Day 6, 05:00 - Early morning pre-dawn operations with gradual ramp-up)."""
...
def generate_sponsor_directives(hour: int = HOUR) -> dict:
    """Generate 12 sponsor decisions at 5-min intervals for hour 125.

    Parameters
    ----------
    hour : int
        The global hour (0-167) to generate directives for. Defaults to 125.
    ...
    decisions: list[dict] = [
        {
            ...
            "safety_gate": "G1",
            "rationale": "Initialize hour-125 monitoring cycle for 7 patients",
        },
        {
            "timestamp": "2026-03-28T05:05:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Validate enrollment criteria for cohort at 05:05",
        },
        {
            "timestamp": "2026-03-28T05:10:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Vitals and robot telemetry monitoring at 05:10",
        },
        {
        ...
        {
            "timestamp": "2026-03-28T05:20:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Confirm consumable levels for hour-125 procedures",
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Validate CRF data integrity for hour 125",
        },
        {
            "timestamp": "2026-03-28T05:35:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G4",
            "rationale": "Anomaly in robot telemetry at 05:35",
        },
        {
            "timestamp": "2026-03-28T05:40:00Z",
        ...
        },
        {
            ...
            "escalation_required": False,
            "safety_gate": "G2",
            "rationale": "Procedure milestone check at 05:45",
        },
        {
            "timestamp": "2026-03-28T05:50:00Z",
            ...
            "escalation_required": False,
            "safety_gate": "G3",
            "rationale": "Discharge readiness for hour-125 treatment cycle",
        },
        {
            "timestamp": "2026-03-28T05:55:00Z",
