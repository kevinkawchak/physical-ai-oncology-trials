...
**8/30: FDA Approves Pancreatic Cancer Drug Rasonque (Daraxonrasib) by Revolution Medicines on August 26, 2026** *Daraxonsrasib is ChemicalQDevice’s number one LLM-focused cancer drug since selected by Google Gemini in June 2025.*
...
**5/10: v3.9.1 (Glioblastoma 1-Minute Variant Instructions)** *On-prem LLM controlled 1-minute glioblastoma resection simulation with 4 cooperating arms at mixed 1 kHz / 10 kHz force resolution and 16-iteration sweep* - 12-file 1-minute set. [![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.18445179-blue)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/competitions/instructions/one_minute_variant)

**5/9: v3.9.0 (Glioblastoma Robotic Surgery Simulation Instructions)** *On-prem LLM controlled glioblastoma stereotactic resection simulation at 1 ms resolution for 1 hour with 64-iteration sweep* - 17-file instruction set at competitions/instructions/ [![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.18445179-blue)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/competitions/instructions)
...
**5/1: v3.4.2 (National 24/7 Continuous RTCT)** *National 24/7 Continuous Real-Time Clinical Trial Simulation - FDA April 2026 Response* - Indefinite-duration continuous trial spanning across 4 sites. [![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.18445179-blue)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/new-trial/national-24-7-trial)
