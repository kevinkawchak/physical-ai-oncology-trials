...
\node[mmstep](p0)  at (4.8,-5.2) {Phase 0 sim validation\\$\geq 1000$ sims, $\geq 2$ frameworks\\USL $\geq 7.0$};
\node[mmstep](dl)  at (4.8,-7.6) {Daraxonrasib dose-cohort\\3+3 escalation, DL1-DL3};
\node[mmgoal](sur) at (0,-7.6)   {Robotic Whipple\\Class II collaborative\\8 arms, oversight};
\node[mmgoal](peri)at (0,-9.7)  {Perioperative advisory\\pause then restart\\T+7 / T+14 / T+21};
\node[mmgoal](eos) at (4.8,-9.7){End of study\\last visit / 24-month OS};
...
robotic Whipple, the perioperative pause-and-restart advisory, and follow-up to 24-month OS endpoint.}
...
\noindent\begin{tabularx}{\textwidth}{L{4.2cm} C{1.85cm} C{1.25cm} C{1.15cm} C{1.55cm} C{1.0cm} C{1.0cm} C{1.45cm}}
\toprule
