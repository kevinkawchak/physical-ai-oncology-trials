# draft-protocol/sections - NIH protocol section files

[![License](https://img.shields.io/badge/License-CC%20BY%204.0-yellow.svg)](https://creativecommons.org/licenses/by/4.0/)
[![Sections](https://img.shields.io/badge/NIH%20sections-13-00417A.svg)](.)

The thirteen `sec-NN-*.tex` files in this directory are the NIH-FDA IND/IDE
protocol sections of the **draft protocol**, one file per section, each
`\input` by [`../main.tex`](../main.tex) in order (Rule 6). See the parent
[`../README.md`](../README.md) for the figure and table inventory and the
sources used.

| File | NIH section |
|:--|:--|
| `sec-00-compliance.tex` | Statement of Compliance |
| `sec-01-summary.tex` | Protocol Summary (Synopsis, Schema, Schedule of Activities) |
