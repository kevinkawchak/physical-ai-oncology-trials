...
- @kevinkawchak added "https://www.chemicalqdevice.com" to main settings, which now features reduced 150KB first page .jpg images for faster load times, and image alt text to improve search engine results.
