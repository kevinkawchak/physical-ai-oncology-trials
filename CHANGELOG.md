...
### Added
- national-platform/national_mcp/ - 3 chunk files for National MCP Servers paper (.tex), references.bib, README.md
- national-platform/federated_learning/ - 3 chunk files for Federated Learning paper (.tex), references.bib, README.md

### Changed
- README.md: Updated version badge to v2.9.2, added chunk directories to repository structure
- releases.md: Added v2.9.2 release notes
- CHANGELOG.md: Added v2.9.2 changelog entry

### Notes
- Chunked papers sourced from national-mcp-pai-oncology-trials and pai-oncology-trial-fl repositories
- Original files in source repositories preserved unmodified
