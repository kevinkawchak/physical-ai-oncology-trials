...
- `funding/capitalization-plan/prompts/` - the master prompt filed verbatim (`prompt-capital.md`) and the full build output (`output-capital.md`), which records the eight defects found and fixed with their measured sizes and the two instructions that could not be followed literally.
