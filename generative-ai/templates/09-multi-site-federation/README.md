# Multi-Site Federation and Federated Learning Manuscript Template

Single column LaTeX academic paper template focused on the
**Multi-Site Federation and Federated Learning** perspective for physical AI oncology trials. This
...
[![Template](https://img.shields.io/badge/Template-09%20multi%20site%20federation-blue.svg)](../)
...
```
Title:    Multi-Site Federation and Federated Learning Manuscript Template
...
disturbing layout. All body text and headings render in black.

## File layout

```
09-multi-site-federation/
  README.md          (this file)
