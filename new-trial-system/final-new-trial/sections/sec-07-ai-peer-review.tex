...
\end{appfig}
\vspace{-0.6cm}
\figcaption{Figure 24. One disagreement from three model reports to five terminal\\dispositions,
none of which is an average and only one of which is silent.}
\end{appfloat}
