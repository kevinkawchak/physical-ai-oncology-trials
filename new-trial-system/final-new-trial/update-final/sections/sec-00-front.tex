...
21 & 7 & Prior against new peer review, nine measured axes & What does one review round cost each way? \\
...
One master prompt was supplied by the author on August 12, 2026. Claude Code
...
moment it was finished. A second author prompt on August 13, 2026 produced this
update stage. The whole document, its twenty-five figures and its twenty-five
tables were therefore finished within three days. The eight stages are recorded
in \appfile{new-trial-system/sub-prompts}, and both prompts are filed verbatim
in \appfile{new-trial-system/prompts}.
...
direct quotation. The final version was the senior author's proof-reading pass.
This update stage, deposited at
\appfile{new-trial-system/final-new-trial/update-final}, repaired three
\texttt{\textbackslash foreach} headers that had stopped the final stage
compiling, redrew Figure 14 as a class diagram, and rewrote
\S\ref{sec:peerreview} around the quantities of Table 21.
