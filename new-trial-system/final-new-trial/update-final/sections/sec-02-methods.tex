...
AI peer review round & 5 & Nov 2025 & \S\ref{sec:peerreview}, Table 24 \\
...
\end{scope}
% The frame has to reach the Author lifeline at x = 0.9 because row 7 returns to
% it, so the frame label is set 9.5 mm inside the west edge, clear of that
% lifeline and its activation bar, rather than at the corner.
\node[mmlanetitle,anchor=north west,font=\tiny\sffamily\bfseries] at ([shift={(9.5mm,-1.2mm)}]lp.north west) {loop [once per generated file]};
