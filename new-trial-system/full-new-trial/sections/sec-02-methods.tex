% sec-02-methods.tex - Section 2, Methods.  FULL stage.
% Figures 3, 4 and 5 drawn; Tables 6 and 7 populated.  Prose held to one page.
\section{Methods}
\label{sec:methods}
...
\begin{apptable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{4.55cm} >{\raggedright\arraybackslash}p{1.65cm} >{\raggedright\arraybackslash}p{2.35cm} >{\raggedright\arraybackslash}X}
