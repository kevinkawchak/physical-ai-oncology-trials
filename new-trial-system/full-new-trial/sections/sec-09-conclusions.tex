% sec-09-conclusions.tex - Section 9, Conclusions.  FULL stage.
% One page.  No figures and no tables: everything here has already been shown,
% and the conclusion's job is to state what follows from it.
\section{Conclusions}
...
described in \S3 and \S4, and every artifact named in this paper exists, is
