% sec-08-limitations-future-work.tex - Section 8.  FULL stage.
% Figure 25 drawn; Table 25 populated.  One page of prose.
...
in \S3 and \S4 is either a published external result or a planned design
parameter. And the review regime of \S7 was measured on a glioblastoma machine
learning workflow rather than on a regulatory dossier; the method transfers, and
the measurement does not. Both limits are removable only by doing the trial,
