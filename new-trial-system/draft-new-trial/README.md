# draft-new-trial - Stage 6 of 8 (the draft paper)

[![Stage](https://img.shields.io/badge/Stage-6%20of%208-800020.svg)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/new-trial-system/draft-new-trial)
...
[![Figures](https://img.shields.io/badge/Figure%20slots-25-6B6B6B.svg)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/new-trial-system/draft-new-trial)
...
[![Sections](https://img.shields.io/badge/Sections-11-2E2E2E.svg)](https://github.com/kevinkawchak/physical-ai-oncology-trials/tree/main/new-trial-system/draft-new-trial/sections)
...
The draft carries the whole skeleton of the paper and none of its finished
prose. It fixes four things that no later stage is allowed to move:

1. **The section set.** Eleven files, one per section, matching `main.tex`.
2. **Figure numbering.** All twenty-five figures are placed as sized
   placeholders through `\figslot`, each carrying its final number and its
   platform tag, so stage 7 replaces a placeholder with a drawing and renumbers
   nothing.
3. **Table numbering.** All twenty-five tables are present with their final
   numbers, their column specifications, and their captions.
4. **The drafting instructions.** Every section carries bracketed instructions
   set with `\draftinstr`, and each one names the exact repository file or
   directory that stage 7 must read to fill the prose around it. No
   `\draftinstr` survives into `full-new-trial`.

## Files

| File | Purpose |
|:--|:--|
| [main.tex](https://github.com/kevinkawchak/physical-ai-oncology-trials/blob/main/new-trial-system/draft-new-trial/main.tex) | Cover page, badges, keywords, clickable contents, `\input` of all eleven sections, `\clearpage` discipline |
| [trialstyle.sty](https://github.com/kevinkawchak/physical-ai-oncology-trials/blob/main/new-trial-system/draft-new-trial/trialstyle.sty) | The burgundy palette, the five TikZ diagram vocabularies, the figure and table carriers, the DOI and prose link machinery |
| [references.bib](https://github.com/kevinkawchak/physical-ai-oncology-trials/blob/main/new-trial-system/draft-new-trial/references.bib) | 122 entries, no duplicate keys, every DOI with a resolver url |
| `sections/sec-00-front.tex` | Abstract, how to read this document, figure index, table index |
...
| `draft-new-trial-LaTeX.zip` | Self-contained Overleaf project for this stage |

## The paper's twenty-five figures, fixed at this stage
...
twice. `draft-new-trial-LaTeX.zip` is a self-contained project.
