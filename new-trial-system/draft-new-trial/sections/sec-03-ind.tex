...
\figslot{diagrams (python)-type / clustered infrastructure}{9.0}{Figure 6. Four source clusters feeding twelve IND modules, and the three\\
...
\figslot{mermaid-type / gantt}{8.2}{Figure 7. Twelve IND modules on one clock: the new system in hours
...
\figslot{d2-type / sql tables}{7.4}{Figure 8. Twelve codified IND content items joined to the section
...
\figslot{graphviz-type / fault tree}{8.6}{Figure 9. The clinical hold as a top event over eight basal failures, with\\
