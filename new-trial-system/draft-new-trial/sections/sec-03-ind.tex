...
prior-system analogue and were composed rather than copied.}
...
modules had no prior-system analogue to copy, and were composed: the Physical AI
...
\headrow \thead{Module} & \thead{Repository source read} & \thead{Window} & \thead{Prior-system analogue}\\
\midrule
