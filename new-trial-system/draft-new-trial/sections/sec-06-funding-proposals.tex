...
\figslot{mermaid-type / gantt}{8.0}{Figure 17. Fourteen funding artifacts deposited between June and
...
\figslot{d2-type / grid}{6.6}{Figure 18. One four-layer budget priced three ways, and the identical\\
direct work set under a 15.0 percent load against a 57 percent rate.}

\figslot{graphviz-type / record with ports}{8.8}{Figure 19. The award as a four-port record, the work package each
...
\figslot{diagrams (python)-type / clustered infrastructure}{9.0}{Figure 20. One evidence store, one production pipeline, and the four
