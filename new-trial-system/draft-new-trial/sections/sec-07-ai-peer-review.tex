...
\figslot{mermaid-type / sequenceDiagram}{9.4}{Figure 21. One manuscript on two clocks: the prior system's serial
...
\figslot{d2-type / grid}{6.4}{Figure 22. Six economic axes of one review round under both regimes,
...
\figslot{plantuml-type / activity with fork and join}{10.2}{Figure 23. One artifact reviewed concurrently by three model
...
\figslot{graphviz-type / decision tree}{9.0}{Figure 24. One disagreement from three model reports to five terminal\\
