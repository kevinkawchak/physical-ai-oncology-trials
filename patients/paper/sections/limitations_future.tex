...
- new-trial/national-24-7-trial/paper/full-paper/sections/limitations\_future.tex
  (Track A vs Track B framing)
- patient-journey/README.md (the single-patient orientation note)
- sponsor/final\_paper/README.md (the synthetic agent decision logic
  note)
...
- The bills do not address pediatric or vulnerable-population
  ...
  documented at national-platform/21cfr50\_adapt/02\_irb\_review\_pediatric.tex
...
extension of patients/patient\_robot\_instructions\_fixed.tex pages
1 through 10 plus the digital-twin infrastructure at
patient-journey/stage\_03\_digital\_twin.py. Cite
...
(sponsor/final\_paper/168\_hours/) as the sponsor-side input and HR
