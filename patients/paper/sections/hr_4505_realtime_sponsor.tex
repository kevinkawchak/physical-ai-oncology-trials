...
- "Patient-sponsor direct channel" means a HIPAA-compliant, FHIR-
  ...
  sponsor/final\_paper/scripts/sponsor\_server/ (the FastAPI sponsor
  control server) and sponsor/paper/sections/safety\_pharmacovigilance.tex
...
- "Real-time" means data from the patient's qualified Physical AI
  ...
  and sponsor/final\_paper/168\_hours/ (Simulation 4: 168 GitHub commits
  across 7 days).
- "Sponsor-side patient interface" means the patient-facing endpoint
  that mirrors sponsor/final\_paper/scripts/sponsor\_server/ but is
...
- Right to send structured AE reports (Common Toxicity Criteria
  ...
  rocque2025remote\_symptom\_monitoring \cite{rocque2025remote_symptom_monitoring}
...
- Right to receive sponsor-side acknowledgment of every patient
  ...
  at national-platform/national\_mcp/ (read all four chunks).
- Right to receive a per-cycle digital twin update reflecting the
  patient's own data submissions; reference
  patient-journey/stage\_03\_digital\_twin.py (the digital-twin
...
- Right to escalate any sponsor-side delay beyond 1 hour to the FDA
  ...
  sponsor/final\_paper/scripts/coordination/ (the agent event bus and
  escalation modules).
...
sponsor/final\_paper/scripts/core\_agents/audit\_trail\_manager.py
...
(i) FOR INDIVIDUAL PATIENTS: A 58-year-old female NSCLC patient
    ...
    analysis at sponsor/final\_paper/scripts/output/sponsor\_24h\_summary.json.
(ii) FOR BROAD ADOPTION: All FDA RTCT pilot trials must expose a
     ...
     sponsor/final\_paper/168\_hours/. Cite \cite{kawchak_2026_19396256},
