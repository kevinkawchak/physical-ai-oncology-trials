...
and at national-platform/new\_trial\_psl/02\_ab2847\_patient\_rights.tex
...
patients/patient\_robot\_instructions\_fixed.tex pages 1 through 10
(also chunked at
patients/patient\_robot\_instructions\_fixed\_chunk/ via
01\_preamble\_robots1to5.tex and 02\_robots6to10\_closing.tex) and
...
and 02\_results\_discussion\_closing.tex for the USL scoring framework.
...
- "Patient robot choice" means the patient's right to select which
  ...
  care. Reference patients/patient\_robot\_instructions\_fixed.tex
  pages 1 to 10.
- "Qualified robot" means a Physical AI system that meets the
  Unification Standard Level (USL) threshold for its category, as
  documented in national-platform/usl\_standard/ and
  unification/usl/paper/usl\_oncology\_trials.tex. Cite
...
- "Robot category" means one of the 10 categories enumerated in the
  ...
  and at national-platform/new\_trial\_psl/01\_preamble\_and\_sb1042.tex,
...
- Right to receive a side-by-side comparison of all qualified robots
  ...
  patient-journey/stage\_05\_surgery.py (da Vinci Xi at USL 87.5 for
  lobectomy), stage\_06\_recovery.py (post-op cobot for limb stabili-
  zation), stage\_07\_immunotherapy.py (Franka Emika at USL 88.75 for
  pembrolizumab), and stage\_09\_surveillance.py (companion robot for
...
- Right to select the specific robot instance (e.g., RTPOS-01 vs
  RTPOS-03) following the patient\_records.md naming pattern at
  new-trial/national-24-7-trial/hour-12/patient\_records.md.
...
protections. Read national-platform/patient\_robot/02\_robots6to10\_closing.tex
for the operational implementation pattern and
sponsor/final\_paper/scripts/safety/ for the safety-workflow integration.
...
sponsor/final\_paper/scripts/core\_agents/ (53 agents, see
sponsor/final\_paper/scripts/core\_agents/\_\_init\_\_.py for the list) that
