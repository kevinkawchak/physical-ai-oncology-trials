...
\hspace{0.5cm} HR 9502 is a recently proposed \textit{Revision of California AB 2847 (2026) Patient
...
control introduced in this set of proposed bills: physical-AI procedure execution
...
and \texttt{02\_robots6to10\_closing.tex} (humanoid, RT motion-tracking, imaging, steerable needle, rehabilitation exoskeleton)
\cite{kawchak_2026_18810541, kawchak_2026_18778219,
target2025robotic_bronchoscopy}.

The operational definition of cancer patient control across six prior
functional dimensions (clinical trial discovery, enrollment comprehension,
location choice, data and biospecimen governance, toxicity warnings,
AI-exclusion contestability) is supplied in the repository through
...
(b) The Unification Standard Level (USL) framework in this bill provides a
four-dimension scoring sheet (capability, safety, autonomy, trust)
that quantifies each of the clinical trial robot's readiness for patient choice on a 0
...
Nature Medicine 2024) demonstrates that AI systems can reach clinical-grade performance across pan-cancer detection; the same pattern
generalizes to robot-executed image-guided procedures
\cite{vorontsov2024virchow}.

\subsection{Definitions}

\hspace{0.5cm} (a) \billterm{Patient robot choice} means the patient's right to
...
(c) {Robot category} in this particular bill means one of the ten patient-facing categories
...
\hspace{0.5cm} (a) Right to receive a side-by-side comparison of all qualified
robots for the patient's cancer procedure, including USL scores, prior
...
\texttt{patient\_records.md} naming pattern located at repository file identification
...
substitute at no added patient cost.

(e) Right to receive a USL transparency report for any robot before
consenting to the use \cite{kawchak_2026_18778219}.
...
(c) Implementation references the operational pattern at the repository file identification
...
\hspace{0.5cm} (a) Annual federal report listing the per-state, per-cancer, per-
...
(c) Civil penalties harmonize with the FDA AI Regulatory Decision-Making Draft 2025 capability-neutrality enforcement framework
\cite{fda_ai_regulatory_decision_draft_2025}.

\subsection{Discussion and Limitation}

\hspace{0.5cm} The bill rests on the assumption that USL scoring is comparable
