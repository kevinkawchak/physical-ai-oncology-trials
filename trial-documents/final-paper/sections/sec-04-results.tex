...
\node[mmctx] (note) at (0,-6.6) {Schedule value highest\\on the critical path};
\node[mmdec] (lim) at (10.4,-6.6) {Gains capped by\\clinical events,\\fixed review clocks};
...
\draw[mmedge] (t4.east) to[out=0,in=200] (out.south west);
\draw[mmedge] (t5.east) to[out=0,in=225] (out.south west);
\draw[mmedge] (t6.east) to[out=0,in=250] (out.south);
