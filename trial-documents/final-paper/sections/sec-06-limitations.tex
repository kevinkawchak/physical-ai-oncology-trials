...
Several limitations follow from the method and the model. The approach does not rely
...
figures, name-matched files, real-time monitorability, and a human in the loop.
