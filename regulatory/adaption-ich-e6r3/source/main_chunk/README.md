...
- The LaTeX preamble (`\documentclass`, `\usepackage`, `\begin{document}`, title page, table of contents) is in chunk 01.
- The document closing (`\printbibliography`, `\end{document}`) is in chunk 04.
- Individual chunks are not standalone compilable LaTeX documents; they must be concatenated to produce a valid file.
