...
Version 4.6.0 is delivered on a separate branch in pull request #76 and is untouched by this release. This release is additive: it adds one new section to the root README and updates the existing badge row, headline entry and repository structure tree in place rather than duplicating them.
