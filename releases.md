...
- funding/capitalization-plan/prompts: the master prompt filed verbatim (prompt-capital.md) and the full Claude Code output (output-capital.md), which records the eight LaTeX defects found and fixed with their measured sizes, how short pages were detected without a page viewer, and the two instructions that could not be followed literally.
...
- funding/capitalization-plan/final-capital: the senior-author pass with clearpage discipline, the author's ten-item correction list from useredits.md applied item by item, every figure improved once more, and every caption at three lines within a three-character spread, plus final-capital-LaTeX.zip. 42 pages. No publication subdirectory.
