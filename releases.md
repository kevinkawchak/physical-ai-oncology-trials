...
- Comprehensive READMEs with badges and source maps in all sixteen directories under new-trial-system.
- Root README updated with the v4.6.0 release badge, four new badges, a dated headline entry, one new section carrying a mermaid build diagram and five tables, and the new-trial-system subtree in the repository structure. CHANGELOG.md updated.
