...
\item[\textbf{Adaption: ICH Harmonised Guideline} \cite{ich-adapt}]
...
\item[\textbf{Physical AI Adaption: 21 CFR Part 50} \cite{cfr50-adapt}]
...
\item[\textbf{Physical AI Adaption: 21 CFR Part 312} \cite{cfr312-adapt}]
...
\item[\textbf{Physical AI Unification Standard Level} \cite{usl-standard}]
Defines the Unification Standard Level (USL) scoring methodology for evaluating
robot readiness across four dimensions: regulatory compliance, clinical
integration, technical maturity, and safety architecture. This document provides
quantitative scoring for ten robot categories used in Physical AI oncology
trials. It is referenced throughout Sections~\ref{sec:psl-usl},
\ref{sec:patient-journey}, and~\ref{sec:discussion} as the robot readiness
evaluation framework.

\item[\textbf{Clinical Trial Site Complete Documentation} \cite{site-docs}]
...
\item[\textbf{A Cancer Patient's Journey, Physical AI} \cite{patient-journey-paper}]
...
\item[\textbf{Patient Instructions: Physical AI Trials} \cite{patient-instructions-paper}]
...
\item[\textbf{Physical AI National MCP Servers} \cite{national-mcp-paper}]
...
\item[\textbf{Physical AI Federated Learning} \cite{fl-paper}]
...
\item[\textbf{Research A: U.S. Government Branch Operations}]
...
\item[\textbf{Research B: California and Federal Regulatory Analysis}]
...
\item[\textbf{Physical AI for Oncology Clinical Trials Repository} \cite{main-repo}]
...
\item[\textbf{National MCP Servers Repository} \cite{mcp-repo}]
...
\item[\textbf{PAI Oncology Trial FL Repository} \cite{fl-repo}]
