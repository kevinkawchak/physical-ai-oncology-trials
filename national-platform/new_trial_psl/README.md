...
> **Note:** This is a copy transferred to `national-platform/new_trial_psl/` for centralized processing. The original files reside in `new-trial/site/all-documents/all_documents_chunk/`.
