...
\begin{longtable}{l p{3.2cm} p{3.2cm} p{3.2cm}}
\caption{Detailed Cost Projections by Implementation Phase (Estimated Ranges in Millions USD)}
...
\begin{longtable}{l p{3.5cm} p{3.5cm} p{2.5cm}}
