...
covering interactions with ten robot types. An example is illustrated in \autoref{Abdomen}. AB 2847 from the site documentation package establishes legally enforceable patient rights including the right to
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth, trim={0 0 0 0}, clip]{Images/Abdomen.jpeg}
    % \vspace{0.1cm}
    \caption{Imaging assistant robot scans liver tumor and guides treatment planning.}
    \label{Abdomen}
\end{figure}
