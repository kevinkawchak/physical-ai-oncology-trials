...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Feedback and improvement (ongoing).} Patient participants in
    ...
    comfort, information adequacy, and overall satisfaction. This feedback informs the continuous improvement processes in Section~\ref{sec:implementation}.
\end{enumerate}
...
clinical trials - as illustrated in \autoref{Walking}.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.690\linewidth, trim={0 0 0 0}, clip]{Images/Walking.jpeg}
    % \vspace{0.1cm}
    \caption{Rehabilitation exoskeleton supports legs and guides walking after bone tumor surgery.}
    \label{Walking}
\end{figure}