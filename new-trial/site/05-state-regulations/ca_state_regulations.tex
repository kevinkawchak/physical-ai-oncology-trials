...
\addbibresource{ca_state_regulations.bib}

\title{%
  \textbf{California Code of Regulations, Title 22}\\[6pt]
  \large Division 5, Chapter 14 (New)\\
  Physical AI Oncology Clinical Trial Site Regulations\\[6pt]
  \normalsize Proposed regulations implementing the California Physical AI\\
  Oncology Clinical Trial Authorization and Site Establishment Act (SB 1042).
}
\author{%
  Kevin Kawchak\\
  CEO, ChemicalQDevice\\
