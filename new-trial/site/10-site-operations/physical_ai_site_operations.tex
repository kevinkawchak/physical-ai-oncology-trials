...
\addbibresource{physical_ai_site_operations.bib}

\title{%
  \textbf{Physical AI Oncology Clinical Trial}\\
  \textbf{Site Activation and Standard Operating Procedures}\\[6pt]
  \large Operational Protocols, Shift Management,\\
  and Quality Assurance for 24-Hour Autonomous Operations\\[6pt]
  \normalsize Standard operating procedures for Physical AI oncology\\
  clinical trial site activation and daily operations.
}
\author{%
  Kevin Kawchak\\
  CEO, ChemicalQDevice\\
