...
gate exercises all five vessels across all eight phases of the operation, and every
verdict is written to the audit trail. The gate is shown in Figure 15.
...
concentric proximity zones around each named vessel drive the response: a
soft-warning zone (3.0 mm) raises an LLM advisory, a no-fly zone (1.0 mm at the
superior mesenteric and portal veins; 1.5 mm at the hepatic artery, celiac axis, and
superior mesenteric artery) blocks the command, and a hard-stop zone (5.0 mm) forces
a $\leq 3$ ms cross-arm E-stop. The gate is sampled at 10 kHz across all eight
...
a cross-arm E-stop that halts the platform in $\leq 3$ ms at a 0.0 N force clamp,
backed by a software-independent hardware E-stop meeting the $\leq 500$ ms
requirement.}
...
to 72 hours after the event, federated across the eight sites, with notification to
