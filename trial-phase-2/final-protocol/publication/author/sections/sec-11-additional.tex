...
\begin{tabularx}{\textwidth}{L{2.4cm} L{3.2cm} Y}
\toprule
\textbf{Jurisdiction} & \textbf{Regulator / framework} & \textbf{Alignment basis} \\
\midrule
European Union & EU MDR + AI reqs & SaMD risk class.; common simulation-validation, federated evidence. \\
...
EORTC  & \fontsize{7.5}{8.5}\selectfont European Organisation for Research and Treatment of Cancer & QoL & Quality of life \\
...
ISM    & Independent Safety Monitor                      & VVUQ  & \fontsize{7.5}{8.5}\selectfont Verification, validation, and uncertainty quantification \\
ITT    & Intention-to-treat                              & MDR   & Medical Device Regulation \\
KRAS   & Kirsten rat sarcoma viral oncogene homolog      & MHRA  & \fontsize{7.5}{8.5}\selectfont Medicines and Healthcare products Regulatory Agency \\
