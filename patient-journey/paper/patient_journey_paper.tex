...
\item \textbf{Real-time diagram generation.} Develop capabilities for generating progress diagrams in real time during actual trial execution, extending the monitoring framework from retrospective illustration to prospective clinical trial oversight.
\end{enumerate}
...
\bibitem{hipaa1996}
U.S. Congress, ``Health Insurance Portability and Accountability Act of 1996 (HIPAA),'' Public Law 104-191, 1996.

\bibitem{mcp2024protocol}
Anthropic, ``Model Context Protocol (MCP),'' Open Protocol Specification, 2024.
...
Kawchak K. A Cancer Patient's Journey Through a Regulated and Autonomous Physical AI Oncology Trial Illustration. Zenodo. 2026; \href{https://doi.org/10.5281/zenodo.19119939}{10.5281/zenodo.19119939}.
