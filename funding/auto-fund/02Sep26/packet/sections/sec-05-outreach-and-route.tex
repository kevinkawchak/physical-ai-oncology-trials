...
The five letters of §2 ask two different sizes of question. Letters 1 and 2 ask
...
The \$2,104,000 line is the reason letters 1 and 2 are not the whole day. An SBIR
route at \$1,606,000 over thirty-three months is a real route and is the only
federal mechanism in the set written for a firm rather than for a person or an
institution \cite{sbapolicydirective}. It is also, on its own, insufficient for
the five-year program, and saying so in the same letter that asks for it is
cheaper than being found out later.
...
rather than annually, and why no instrument is signed before the effect of that
instrument on the registry answer is written down. Day 2 of this block sets out
three candidate instruments side by side for exactly that reason.
...
clause in three separate chapters as the mechanism written for a firm
\cite{kratsios2026sciencegoldenage}. Its annexed budget priorities memorandum
...
\cite{eo14363genesismission,eo14303goldstandard}. Every letter in §2 is written
inside that frame and none of them argues with it.
