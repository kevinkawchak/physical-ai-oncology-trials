...
intended partner of choice, at the feasibility stage only. It is described in
none of them, and not in this paper, as a partner, sponsor, trial site, or
endorser, and will not be without written authorization. No agreement of any
kind exists. The one application addressed to the institution asks for a
45-minute meeting.
...
sought, not secured, and the first-year gate reads \textit{site executed} rather
than \textit{site confirmed}. An application that overstated the relationship
would fail its own go or no-go condition in year one.
...
dependency, and drawing any of them again would be duplication rather than a new
perspective. The requirement that every figure be a unique perspective is a
constraint on adding figures, not a quota to fill.
...
The first correction is the kind of error that survives review.
\textit{First-in-human} was true of the integrated workflow and false of the
drug, and in a title the two readings are indistinguishable. A reviewer at a
drug-development office would have caught it at once and discounted everything
after it. The correction cost two sentences; not making it would have cost the
application.
...
The UC San Diego route is trial-first because Moores has the pancreatic surgical
volume and the trial operations the study needs. The Scripps route is AI-first
because the value it can add is independent evaluation of the verification
methods, and asking a methods group to host a surgical trial would waste the
introduction.
...
it. A productive outcome is an invitation to present, a clinical principal
investigator identified, acceptance into a feasibility process, a preliminary
budget and accrual estimate, a technical review, a defined regulatory pathway,
or support for a grant application. None of those is a trial, and none is
described as one.
...
insurance, the review board approval, and the operational resources are all
documented. That sentence is in the site research, in every application's back
matter, and here, and it is the same sentence in all three places.
