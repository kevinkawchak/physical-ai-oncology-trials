...
\end{appfig}
\vspace{-0.7cm}
\figcaption{Five layers, executed twice. The left column is one operator with\\
an LLM toolchain and a public repository; the right is the\\
institutional equivalent. Only the bottom layer is common to both.}
\end{appfloat}
