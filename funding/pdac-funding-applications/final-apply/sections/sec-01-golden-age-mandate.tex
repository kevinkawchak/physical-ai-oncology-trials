...
\cite{foundingdocs}, none carrying indirect cost. Three trial simulations were
completed at an estimated \$36,330 each against an industry benchmark running
from \$120,000 for a single empirical virtual trial to more than \$2 million for
a ten-arm quantitative systems pharmacology trial \cite{daraxsims}.
