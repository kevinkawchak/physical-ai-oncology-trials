...
cost share, no program income anticipated \cite{fundapp2}. The report asks that
long-duration grants be fully funded in year one; issued that way, year one
closes the site agreement, the IRB submission, and IND activation together
...
2 & \$700,000 & Dose level 1 cohort, first three participants, 30-day safety review & No unexpected grade 4 event \\
3 & \$700,000 & Escalation to RP2D, cohorts 2 and 3, interim advisory audit & MTD or RP2D declared \\
...
and trial operations, confirmation of a qualified investigator willing to lead
or sponsor, then an investigator-initiated trial intake with a budget and
accrual estimate. UC San Diego is not described here as a partner, sponsor,
site, or endorser, because no written authorization exists.
