...
Industry benchmarks put a single virtual trial run above \$120,000 and 4.5
months, and a quantitative systems pharmacology trial above \$2 million and
several months to a year or more. The three simulations here cost an estimated
\$36,330 each and took about a month each \cite{daraxsims}: the concrete form of
the report's argument that one scientist with modern tools can now attempt work
previously associated with larger organizations.
