...
% STAGE 3.  Three column widths retuned; the stall schedule's Dimension column
% widened so "9 by 18 feet, one van-accessible at 11 feet" sets on two lines.
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{1.4cm} >{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}X}
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{4.2cm} >{\raggedright\arraybackslash}p{2.9cm} >{\raggedright\arraybackslash}X}
