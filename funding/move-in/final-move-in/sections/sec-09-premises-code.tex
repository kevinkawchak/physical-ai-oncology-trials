...
% STAGE 3.  The four-zone table's Rooms and Who-may-enter columns retuned: at
% stage 2 the Rooms cell wrapped to four lines while the credential cell wrapped
% to two, which reads as a column that was sized by eye rather than by measure.
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.7cm} >{\raggedright\arraybackslash}p{4.0cm} >{\raggedright\arraybackslash}p{2.9cm} >{\raggedright\arraybackslash}X}
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{4.8cm} >{\raggedright\arraybackslash}p{2.7cm} >{\raggedright\arraybackslash}X}
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{3.0cm} >{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{3.1cm} >{\raggedright\arraybackslash}X}
