...
% STAGE 3.  The one \clearpage inside a document in this whole package is here,
% before section 6.  In stage 2 the commissioning table filled the page section 5
% left and its caption was pushed alone onto the next page, which then carried
% three lines and 96 percent white space.  The barrier moves the heading, the
% table and the caption together.  Two column widths retuned.
