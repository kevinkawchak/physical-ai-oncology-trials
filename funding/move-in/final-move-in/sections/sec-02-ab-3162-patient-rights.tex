...
% STAGE 3.  Two column widths retuned against the longest cell in each; a
% \needspace binds the paragraph that explains subdivision (a) to the list it
% explains, so the two cannot be separated by a page break.
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{4.0cm} >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}X}
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{4.9cm} >{\raggedright\arraybackslash}p{2.8cm} >{\raggedright\arraybackslash}X}
