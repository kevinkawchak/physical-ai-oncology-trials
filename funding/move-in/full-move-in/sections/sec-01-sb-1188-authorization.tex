...
\item Simulation work completed between 2025 and 2026 supports, without
  establishing, a hypothesis that a targeted agent combined with a staged
  robotic resection may be studied safely in the resectable setting. A ten-arm
...
\begin{mvtable}
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.0cm} >{\raggedright\arraybackslash}p{3.8cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}X}
