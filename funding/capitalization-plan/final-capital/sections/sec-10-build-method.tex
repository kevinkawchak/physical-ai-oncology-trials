...
Nine defects were found and fixed during the build rather than carried forward,
...
tall for. The last was arithmetic: the draft index counted nineteen tables where
the paper carries twenty-one, and sixteen cross-references were renumbered
