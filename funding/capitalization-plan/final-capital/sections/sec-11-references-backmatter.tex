...
% unsrt list is ordered by first appearance.  Every entry carrying a DOI prints
% the DOI as text with a clickable target, and \UrlBreaks is re-asserted after
% url and hyperref so no reference line runs past the right margin.
\section*{Back Matter}
