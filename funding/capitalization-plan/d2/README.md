...
| [`fig-10-capital-tiers.d2.md`](fig-10-capital-tiers.d2.md) | 10 | 4 | nested containers | Where does every dollar come from, and what separates the tiers? |
...
| Nesting too deep | No container nests more than two deep. Figures 8 and 10 each nest exactly one level |
...
| Edge overlap | Figure 5 carries three edges and states the bend on the only one that could cross a record. Figure 10's four crossings are vertical, at two fixed x values |
| Corridor collision | Figures 5, 10, 16 each reserve a corridor of 10 mm or more that carries no node; in Figure 10 the two 16 mm firewall bands are the subject of the figure |
...
| $900,000 + $5,000,000 = $5,900,000 | Figure 10, tier 3 | Yes |
| $5,900,000 divided by $1,606,000 = 3.67 | Figure 10, leverage | Yes, to two places |
...
| `chunk-08` annex | `../../science-golden-age` | Figure 10's 3:1 leverage target |
| `final-apply/sections/sec-08-budget-and-leverage.tex` | `../../pdac-funding-applications` | Figure 8's four-layer frame and Figure 10's unpriced categories |
| `final-apply/sections/sec-05-trial-evidence.tex` | `../../pdac-funding-applications` | Figure 16's six quantities and four limitations |
| `applications/app-05-nih-sbir-seed/` | `../../pdac-funding-applications` | Figures 8 and 10, the two award amounts |
