# full-capital/sections - the twelve section sources
...
[![Stage kind](https://img.shields.io/badge/Contents-Every%20instruction%20resolved-6C757D.svg)](..)
...
At this stage the twelve files carry twenty TikZ figures and twenty-one full-width tables.

Every `\draftinstr` is resolved by reading the file it named. Nothing bracketed survives. Every money table reconciles to the eight numbers in the hub README.
