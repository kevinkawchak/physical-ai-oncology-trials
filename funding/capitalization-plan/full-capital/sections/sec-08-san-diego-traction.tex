...
\node[font=\tiny\itshape,text=protogray,anchor=north west,text width=132mm]
  at (0,-6.85) {Rows 2 and 3 are drawn paler than the other three because they
...
\end{appfig}
\vspace{-0.65cm}
\figcaption{Four contacts between July 29 and August 8, 2026, and what each\\
...
Figure 14, the earliest of the five at month six.
...
cheapest row in Table 13, and until it closes nothing else in this document can
begin.
