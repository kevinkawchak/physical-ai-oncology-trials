...
% Tables 13 and 14 are keyed by the same twelve IDs.
...
\node[d2title,anchor=south] at (1.55,-1.72) {A, company};
\node[d2title,anchor=south] at (6.90,-1.72) {B, site};
\node[d2title,anchor=south] at (12.25,-1.72) {C, independent};
...
\node[font=\tiny\itshape,text=protogray,anchor=north west,text width=132mm]
  at (-0.40,-7.35) {The top event is a stop without a deposited archive, not a
