SCRIPPS INBOUND STRATEGY
AI ONCOLOGY WORKS → FUNDING AND CLINICAL-TRIAL PARTNERSHIP
...
VERIFICATION-FIRST AI FOR ONCOLOGY CLINICAL TRIALS
Public Research Portfolio by Kevin Kawchak and ChemicalQDevice

Use this subtitle:

Protocols, regulatory documents, quantitative simulations and governed LLM workflows designed to accelerate oncology trial development while preserving human clinical authority.

Place this contact line prominently at the top and bottom:
...
The portfolio uses multiple frontier AI systems for independent drafting, review and discrepancy identification.

Claude Code supports repository-scale production.

ChatGPT supports independent review, research, verification and document analysis.

Gemini supports additional review and correction.

The human investigator retains responsibility for every scientific, clinical and regulatory conclusion.

Page 2 should explain why Scripps may be interested:

Independent evaluation of verification-first medical AI.

Digital clinical-trial design.

AI-supported protocol and regulatory-document development.

Reproducible provenance and audit trails.

Human-factors testing.

Validation of bounded AI recommendations.
...
The five selected works.

A chronological research timeline.

Links to GitHub, ResearchGate and ORCID.

A diagram of the multi-model review workflow.

A table distinguishing simulation results from human clinical evidence.

A section titled “What Has Not Yet Been Validated.”

A section titled “Potential Institutional Evaluation.”

A direct invitation for Scripps investigators to contact Kevin.
...
Fund the entire clinical trial.

Endorse the results.

Provide patients.

Provide operating-room access.

Allow an AI system to participate in surgery.
...
A pancreatic cancer medical oncologist.

A pancreatic surgical oncologist.

A clinical-trial operations representative.

A biostatistician.

An institutional regulatory specialist.
...
10710 North Torrey Pines Road
La Jolla, CA 92037
Phone: 858-554-8788

Louis Rivera, MD
Surgical oncologist treating pancreatic and gastrointestinal cancers, with minimally invasive and robotic surgical experience.

Scripps Cancer Center
10670 John J. Hopkins Drive
San Diego, CA 92121
Phone: 858-554-8984
...
La Jolla, CA 92037
Email: dtc@scripps.edu

Suggested attendees:

Kevin Kawchak.

Giorgio Quer or an AI-team representative.

Edward Ramos or a digital-trials representative.
...
Sponsor-a-study and institutional research inquiry:
858-648-6402

General clinical-research information:
858-678-6402

Ask for an institutional feasibility pathway covering:
...
Clinical and Translational Science relevance section.

Approximately 200-word community-engagement section.
...
A Generalizable Verification and Provenance Framework for LLM-Assisted Clinical-Trial Development

Do not use this as the pilot title:

Daraxonrasib Robotic Whipple Clinical Trial

The pilot should test questions such as:

Can independent AI-model review reliably identify unsupported clinical and regulatory claims?

Can repository and source provenance reduce document-development errors?

Can human reviewers reproduce the reasoning behind AI-generated trial materials?

Which disagreements among AI models predict genuine document defects?
...
Scripps sponsor-a-study intake.

Scripps institutional protocol review.

Scripps IRB application.

Conflict-of-interest disclosures.

Clinical-trial budget and coverage analysis.

ClinicalTrials.gov registration.

FDA IND meeting request and application materials.

FDA device or software Q-Submission materials, when applicable.

Drug-manufacturer confidentiality and clinical-supply agreements.

Clinical-trial agreement.

Data-use and intellectual-property agreements.
...
An independent review of the AI verification framework by a medical-AI researcher.

A reproducibility report from someone who was not involved in developing the repository.

A documented comparison between AI-generated documents and recognized FDA, NIH or ICH requirements.

A red-team report identifying unsafe or unsupported outputs.

A manuscript or preprint focused on the generalizable AI method.

A public demonstration showing provenance, model disagreement and human resolution.
...
Relevant San Diego biotechnology and medical-AI communities.

CONNECT San Diego.

Curebound research and cancer-community events.

Pancreatic Cancer Action Network activities.

Use the wording:

San Diego-based public research seeking independent scientific evaluation.

Do not write:

Developed with Scripps.

Scripps-supported.

Scripps clinical trial.
...
Build the consolidated evidence page.

Create the two-page Scripps Review Brief.

Clean the five featured repositories.

Add limitations, provenance and contact sections.

Days 8–14:

Publish the portfolio.

Post one professional announcement.

Send the single visibility notice to dtc@scripps.edu and the identified research contacts.

Do not attach the entire grant ZIP.

Days 15–21:

Publish one technical demonstration or independent review.

Prepare the generalizable Scripps pilot concept.

Prepare a one-page clinical application summary, but keep it separate from the initial AI communication.

Days 22–30:

Respond promptly if Scripps contacts Kevin.

Offer a 30-minute AI-portfolio review meeting.
...
A successful first response is one of the following:

A request to review additional AI materials.

An invitation to present the portfolio.

An introduction to an AI investigator.

An introduction to Clinical Research Services.
