...
agent.}
\label{tab:sec07-map}
\begin{tabularx}{\textwidth}{L{3.5cm} L{3.7cm} Y}
\toprule
...
content is incorporated by cross-reference; the perioperative drug-distribution
...
for the perioperative PDAC study.}
...
\figcaption{Table 8.3. Pharmacodynamic markers of daraxonrasib and their use in the
...
\figcaption{Table 8.4. The perioperative restart-advisory decision matrix. A
...
of Table 8.4. The 90.6 percent T+7d proportion (29 of 32) and the 9.4 percent
...
\figcaption{Table 8.5. The 32-iteration deterministic perioperative pharmacokinetic
...
\figcaption{Table 8.7. Anticipated toxicity profile of perioperative daraxonrasib.
The gastrointestinal and dermatologic events are the dominant, dose-related class
effects and the most likely DLT category; the anastomotic-healing hazard is a
schedule hazard mitigated structurally by the restart advisory.}
...
exposure thresholds principally rests \cite{qspmetpancre}. The digital-twin
...
documented VVUQ record is the primary computational basis; the remaining works are
