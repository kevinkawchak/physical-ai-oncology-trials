...
\cite{phase1guidance, daraxwhipple}. The perioperative pause-and-restart advisory
...
developed in full in the protocol and are cited here to show that the prior
...
\end{tabularx}
\vspace{-0.2cm}
\figcaption{Table 9.5. Exact 95 percent Clopper-Pearson confidence intervals for
representative observed proportions at cohort and full-study sample sizes. The wide
intervals confirm the descriptive, non-confirmatory posture of the study relative
to the Dutch 2025 benchmark.}
...
\end{mermaidfig}
\vspace{-0.4cm}
\figcaption{Figure 18. Post-submission IND maintenance authoring once the IND is in
...
\needspace{11\baselineskip}
\noindent\begin{tabularx}{\textwidth}{L{4.4cm} L{4.0cm} Y}
\toprule
...
Monitor carry halt and stop authority respectively; the Physical AI Safety Review
...
that the first direct human experience generated by this study is acquired within a
fully characterized and continuously monitored envelope \cite{daraxwhipple,
