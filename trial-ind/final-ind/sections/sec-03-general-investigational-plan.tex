...
\S 312.404 \cite{onpremwhippl,daraxwhipple}. A vascular no-fly gate continuously
...
a specific element of the intervention \cite{daraxwhipple,onpremwhippl}.
...
\draw[mmedge] (ex) -- (e1);
\end{mermaidfig}
\figcaption{Figure 11. The objective-to-endpoint hierarchy of the general
...
human-confirmed before it is acted upon.}
...
\needspace{12\baselineskip}
\noindent\begin{tabularx}{\textwidth}{L{4.6cm} L{3.0cm} Y}
\toprule
...
\needspace{10\baselineskip}
\noindent\begin{tabularx}{\textwidth}{C{3.0cm} C{3.4cm} C{3.4cm} Y}
\toprule
...
\addlinespace
0.40 & $\approx$ 0.22 & $\approx$ 0.78 & A toxic level rarely escalates outright; the MTD is likely set below it. \\
\bottomrule
\end{tabularx}
...
level most of the time, the intended first-in-human behavior.}
