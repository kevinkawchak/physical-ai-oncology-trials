...
\bottomrule
\end{tabularx}
\figcaption{Table -.1. Provenance map linking each evidentiary strand to its
...
sentence and every quantitative value remained auditable. The author thanks
...
regulatory advice. It is not endorsed by the United States Food and Drug
...
\href{https://doi.org/10.5281/zenodo.xxxxxxxx}{10.5281/zenodo.xxxxxxxx}. The four
...
stage holds this senior-author polished application. The underlying proposed clinical
...
\begin{table}[htbp]
\centering
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.8cm} Y >{\raggedright\arraybackslash}p{3.0cm}}
\toprule
\textbf{Build stage} & \textbf{Contents and role in the reproducible record} & \textbf{Archive} \\
\midrule
\texttt{mermaid} & Grayscale Mermaid figure specifications (8-tone classDef ramp) that map 1:1 to the TikZ figures & Zenodo CC BY 4.0; DOI 10.5281/zenodo.xxxxxxxx \\
...
\bottomrule
\end{tabularx}
\figcaption{Table -.3. The four build-stage source trees that together form the
